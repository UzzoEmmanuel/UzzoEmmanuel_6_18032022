...
exports.modifySauce = (req, res, next) => {
  //2 cas possible: si on modifie l'image ou si on modifie les informations.
  ...
  Sauce.updateOne(
    { _id: req.params.id }, //objet de comparaison: on veut que l'id de la sauce soit égual au paramètre de requête.
